      ...
      <el-row class="andon-analysis-content">
        <el-col class="content-item" :span="6">
          <div class="content-item-top">
            ...
            <div class="charts-height">
              <line-time-out-rate-charts id="line_timeout" name="响应时间超时率" :overtime="responseTime.responseOvertimeCount" :noOvertime="responseTime.responseNoOvertimeCount" />
            </div>
          </div>
          <div class="content-item-bottom">
            <v-title title="处理时间超时率"></v-title>
            <div class="charts-height">
              <line-time-out-rate-charts id="line_timeout1" name="处理时间超时率" :overtime="processTime.processOvertimeCount" :noOvertime="processTime.processNoOvertimeCount" />
            </div>
          </div>
        </el-col>
        <el-col class="content-item" :span="9">
          <div class="content-item-top">
            ...
            <div class="charts-height">
              <line-response-charts id="response" name="响应平均时间趋势" :date="date" :dataList="responseAverageTimeChart"></line-response-charts>
            </div>
          </div>
          <div class="content-item-bottom">
            <v-title title="处理平均时间趋势"></v-title>
            <div class="charts-height">
              <line-response-charts id="response1" name="处理平均时间趋势" :date="date"  :dataList="processAverageTimeChart"></line-response-charts>
            </div>
          </div>
        </el-col>
        <el-col class="content-item" :span="9">
          <div class="content-item-top">
            ...
            <div class="charts-height">
              <line-alarm-charts id="alarm" :dataList="alarmProblemTop5"></line-alarm-charts>
            </div>
          </div>
          <div class="content-item-bottom">
            <v-title title="报警处理时间TOP5"></v-title>
            <div class="charts-height">
              <line-alarm-charts id="alarm1" :dataList="alarmProcessTimeTop5">></line-alarm-charts>
            </div>
          </div>
        </el-col>
      </el-row>
...
import lineResponseCharts from './lineResponseCharts'
import lineAlarmCharts from './lineAlarmCharts'
import lineTimeOutRateCharts from './lineTimeOutRateCharts'
export default {
  data () {
    return {
      responseTime: {
  ...
  components: { board, lineResponseCharts, lineAlarmCharts, lineTimeOutRateCharts }
}
</script>
