  ...
  <board   bTitle="制程产能分析">
    <el-row class="capacity-analysis-item">
      ...
      <el-col :span="8" class="analysis-rate split-line">
        <div style="height:85%">
          <achive-rate id="achiveRate" :rate="rate" ></achive-rate>
        </div>
      ...
      <el-col :span="24" class="analysis-capaity" style="border-top: 0.4vh solid #0f0c2d">
        ...
        <day-capacity id="daycapaity" style="height:85%" :capacityData="productivityTrendChart" :dateList="dateList"></day-capacity>
      </el-col>
    </el-row>
  </board>
</template>
...
export default {
  ...
  methods: {
    ...
    async getVisualProductivity () {
      ...
      this.createDateList()
      if (res.code === '200') {
        this.productivityTrendChart = res.data.productivityTrendChart
