...
<div class="mes-main mes-work-order">
  <h3 class="mes-main-title">IPQC规则维护</h3>
  ...
  <div class="mes-table">
    <el-row class="mes-table-handle">
      <el-col :span="12">
          <el-button size="mini" @click="handleIPQC(true)">编辑</el-button>
          <span class="split-line">|</span>
          <el-button size="mini" @click="handleIPQC(false)" >新增</el-button>
          <span class="split-line">|</span>
...
export default {
  ...
  computed: {
    dialogTitle () {
      return this.isEdit ? '编辑IPQC规则维护' : '新增IPQC规则维护'
    }
  },
  methods: {
    indexMethod (index) {
