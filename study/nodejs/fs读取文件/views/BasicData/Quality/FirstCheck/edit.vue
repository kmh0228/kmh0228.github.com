<template>
 <div class="mes-main mes-main-common">
    <div class="main-common-head" >
      ...
      <span class="status_class" style="margin-left:3vw">状态：{{ firstCheckState }}</span>
    </div>
   <el-card class="box-card"  shadow="never" >
      ...
      <el-form :model="infoData" ref="infoData" :rules="rules"   label-width="120px" label-position="left" class="el-row mes-form-rule"  style="margin-top:1.5vh"  size="mini">
        ...
        <el-form-item label="位置" class="el-col el-col-7 el-col-offset-1" :disabled="true">
          <el-input  :disabled="true" v-model="infoData.location" style="width:100%"></el-input>
        </el-form-item>
        <el-form-item label="班别"  prop="mPomShiftId" class="el-col el-col-7" :disabled="true">
...
export default {
  ...
  computed: {
    buttonDisabled () {
      return this.firstCheckState === '已提交'
    }
  },
  methods: {
    dispatchNg (row) {
