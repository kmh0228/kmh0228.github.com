<template>
 <div class="mes-main mes-main-common">
    <div class="main-common-head" >
      <el-button type="primary" plain size="mini" @click="saveData('UN_REGISTER')">保存</el-button>
      <el-button type="primary" plain size="mini" @click="saveData('REGISTERED')">登记</el-button>
   ...
   <el-card class="box-card"  shadow="never" >
      ...
      <el-form :model="infoData" ref="infoData" :rules="rules"   label-width="120px" label-position="left" class="el-row mes-form-rule"  style="margin-top:1.5vh" size="mini">
        ...
        <el-form-item label="产品系列" prop="model" class="el-col el-col-7  el-col-offset-1">
        ...
        <el-form-item label="工单数量"  prop="jobOrderQty"  class="el-col el-col-7  el-col-offset-1">
        ...
        <el-form-item label="位置" prop="location" class="el-col el-col-7  el-col-offset-1">
          <el-input v-model="infoData.location" style="width:100%" placeholder="请输入位置"></el-input>
        </el-form-item>
