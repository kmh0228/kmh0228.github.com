...
(function(j) {
	false ? define(["jquery", "datatables.net", "datatables.net-buttons"], function(k) {
	...
	var N = function(a) {
		...
		G = function(a, c) {
			for (var d = F(c), b = a.buttons.exportData(c.exportOptions), e = c.fieldBoundary, f = c.fieldSeparator, g = RegExp(e, "g"), n = c.escapeChar !== q ? c.escapeChar : "\\", j = function(a) {
...
console.log('2 buttons.html5.min.js loaded');
